 ...
 * @version    $Id: random.php 147 2010-04-20 09:16:54Z gilles $
 ...
 */
function wikula_randomblock_init()
{
    // Security
 ...
 */
function wikula_randomblock_info()
{
 ...
 */
function wikula_randomblock_display($blockinfo)
{
    ...
    $content = $render->fetch('wikula_block_random.tpl', md5($page['id'].$page['time']));
 ...
 */
function wikula_randomblock_modify($blockinfo)
{
    // Get current content
    $vars = pnBlockVarsFromContent($blockinfo['content']);
	...
	return $render->fetch('wikula_block_random_modify.tpl');
}
 ...
 */
function wikula_randomblock_update($blockinfo)
{
    // Get current content
    $vars = pnBlockVarsFromContent($blockinfo['content']);
	...
	$render = pnRender::getInstance('wikula');
	$render->clear_cache('wikula_block_random.tpl');
