<!--[* $Id: wikula_action_categorycategory.tpl 41 2008-10-09 18:29:16Z quan $ *]-->
...
<!--[if $action_cc.pages]-->
    ...
    <table<!--[if $action_cc.full]--> width="100%"<!--[/if]-->>
      ...
      <thead>
        <tr>
          <th<!--[if $action_cc.col > 1]--> colspan="<!--[$action_cc.col]-->"<!--[/if]-->>
            <!--[gt text='Pages that belong to this category ']--> <a href="<!--[pnmodurl modname='wikula' tag=$action_cc.tag|urlencode]-->" title="<!--[$action_cc.tag]-->"><!--[$action_cc.tag]--></a> (<!--[$action_cc.total]-->)
          </th>
        </tr>
      </thead>
      <tbody>
      <!--[/if]-->
        ...
        <!--[foreach from=$action_cc.pages item='action_cc_page' name='action_cc_pages']-->
          <td>
            <a href="<!--[pnmodurl modname='wikula' tag=$action_cc_page.page_tag|urlencode]-->" title="<!--[$action_cc_page.page_tag]-->"><!--[$action_cc_page.page_tag]--></a>
          </td>
  ...
  <!--[else]-->
    <!--[if $action_cc.notitle eq 0]-->
    <h5><!--[gt text='Pages that belong to this category ']--> <a href="<!--[pnmodurl modname='wikula' tag=$action_cc.tag|urlencode]-->" title="<!--[$action_cc.tag]-->"><!--[$action_cc.tag]--></a></h5>
    <!--[/if]-->
    <div class="categorycategory">
      <ul>
        <!--[foreach from=$action_cc.pages item='action_cc_page']-->
        <li><a href="<!--[pnmodurl modname='wikula' tag=$action_cc_page.page_tag|urlencode]-->" title="<!--[$action_cc_page.page_tag]-->"><!--[$action_cc_page.page_tag]--></a></li>
        <!--[/foreach]-->
      </ul>
    </div>
  <!--[/if]-->
