<!--[* $Id: wikula_user_edit.tpl 83 2008-12-17 04:04:58Z mateo $ *]-->
...
<div id="wikula">
  <div class="page">
    ...
    <form action="<!--[pnmodurl modname='wikula' type='user' func='edit' fqurl=true]-->" method="post" enctype="application/x-www-form-urlencoded">
    <div id="wikula_editform">
      <input type="hidden" name="previous" value="<!--[$previous|pnvarprepfordisplay]-->" />
      <input type="hidden" name="tag" value="<!--[$tag|pnvarprepfordisplay]-->" />
