...
<div id="wikula">
  <div class="page">
    ...
    <div class="refmenu">
      <ul class="menu">
        <li><a href="<!--[pnmodurl modname='wikula' func='referrers' tag=$tag|urlencode]-->" title="<!--[gt text='Referrers to']--> <!--[$tag]-->"><!--[gt text='Referrers to']--> <!--[$tag]--></a></li>
        <li><a href="<!--[pnmodurl modname='wikula' func='referrers' sites=1 tag=$tag|urlencode]-->" title="<!--[gt text='Domains linking to %thispage%' thispage=$tag]-->"><!--[gt text='Domains linking to %s' tag1=$tag]--></a></li>
        <li><a href="<!--[pnmodurl modname='wikula' func='referrers' global=1 tag=$tag|urlencode]-->" title="<!--[gt text='Referrers to this wiki']-->"><!--[gt text='Referrers to this wiki']--></a></li>
        <li><a href="<!--[pnmodurl modname='wikula' func='referrers' sites=1 global=1 tag=$tag|urlencode]-->" title="<!--[gt text='Domains linking to this wiki']-->"><!--[gt text='Domains linking to this wiki']--></a></li>
        <!--<li><a href="http://wikkawiki.org/HomePage/review_blacklist">Blacklisted sites</a></li>-->
      </ul>
    </div>
    <br class="clear" /><br />
    <form action="<!--[pnmodurl modname='wikula' type='user' func='Referrers' tag=$tag|urlencode]-->" method="post" enctype="application/x-www-form-urlencoded" id="form_refform">
    <div>
    ...
    <div class="refmenu">
      <ul class="menu">
        <li><a href="<!--[pnmodurl modname='wikula' func='referrers' tag=$tag|urlencode]-->" title="<!--[gt text='Referrers to']--> <!--[$tag]-->"><!--[gt text='Referrers to']--> <!--[$tag]--></a></li>
        <li><a href="<!--[pnmodurl modname='wikula' func='referrers' sites=1 tag=$tag|urlencode]-->" title="<!--[gt text='Domains linking to %thispage%' thispage=$tag]-->"><!--[gt text='Domains linking to %thispage%' thispage=$tag]--></a></li>
        <li><a href="<!--[pnmodurl modname='wikula' func='referrers' global=1 tag=$tag|urlencode]-->" title="<!--[gt text='Referrers to this wiki']-->"><!--[gt text='Referrers to this wiki']--></a></li>
        <li><a href="<!--[pnmodurl modname='wikula' func='referrers' sites=1 global=1 tag=$tag|urlencode]-->" title="<!--[gt text='Domains linking to this wiki']-->"><!--[gt text='Domains linking to this wiki']--></a></li>
        <!--<li><a href="http://wikkawiki.org/HomePage/review_blacklist">Blacklisted sites</a></li>-->
      </ul>
  ...
  <div class="wiki_footer">
    <div style="text-align:left; padding:4px;">
      ...
      <div>
        <!--[if $accessedit]-->
        <a href="<!--[pnmodurl modname='wikula' func='edit' previous=$page.id|urlencode tag=$tag|urlencode]-->" title="<!--[gt text='Edit page']-->"><!--[gt text='Edit page']--></a>
        ...
        <a href="<!--[pnmodurl modname='wikula' tag=$tag|urlencode time=$page.time|urlencode]-->" class="datetime"><!--[$page.time|pnvarprepfordisplay]--></a> <a href="<!--[pnmodurl modname='wikula' func='RevisionsXML' tag=$tag|urlencode theme='rss']-->" title="<!--[$altrssfeed]-->"><!--[pnimg src='rss.png' alt=$altrssfeed modname='wikula']--></a>
        <span class="text_separator">::</span>
