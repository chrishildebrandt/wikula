<!--[* $Id: wikula_action_mychanges.tpl 41 2008-10-09 18:29:16Z quan $ *]-->

<div class="action_mychanges">

<div class="floatl">
<!--[if $alpha eq 1]-->
    <!--[gt text='This is a list of pages you']-->(<a href="<!--[pnmodurl modname='wikula' tag=$tag|urlencode]-->" title="<!--[gt text='order by date']-->"><!--[gt text='order by date']--></a>).
<!--[else]-->
    <!--[gt text='This is a list of pages you']-->(<a href="<!--[pnmodurl modname='wikula' tag=$tag|urlencode alpha=1]-->" title="<!--[gt text='order alphabetically']-->"><!--[gt text='order alphabetically']--></a>).
<!--[/if]-->
</div>
<div class="clear">&nbsp;</div>
...
<!--[else]-->
    ...
    <!--[foreach name='mychanges' from=$pagelist item='pages' key='key']-->
      ...
      <!--[foreach from=$pages item='page']-->
        &nbsp;&nbsp;&nbsp;
        (<a href="<!--[pnmodurl modname='wikula' tag=$page.tag|urlencode time=$page.time|urlencode]-->" title="<!--[gt text='Revisions']-->"><!--[$page.timeformatted]--></a>)
