<!--[* $Id: wikula_init_step2.tpl 83 2008-12-17 04:04:58Z mateo $ *]-->
...
<form class="z-form" action="<!--[pnmodurl modname='wikula' type='init' func='step2']-->" method="post" enctype="application/x-www-form-urlencoded">
<div>
  ...
  <input type="hidden" name="wikulainit[wikkaprefix]" value="<!--[$wikkaprefix|pnvarprepfordisplay]-->" />
  <!--[/if]-->
<fieldset>
  ...
  <div class="z-formrow">
    ...
    <input id="wikula_bold" type="text" name="wikulainit[root_page]" size="30" value="<!--[$root_page|pnvarprepfordisplay]-->" />
  ...
  <div class="z-formrow">
    ...
    <input id="wikula_itemsperpage" type="text" name="wikulainit[itemsperpage]" size="3" value="<!--[$itemsperpage|pnvarprepfordisplay]-->" />
  </div>
  ...
  <!--[pnimg src='wizard.gif' __alt='wizard' modname='wikula']-->
  </div>
