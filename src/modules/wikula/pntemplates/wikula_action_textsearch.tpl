<!--[* $Id: wikula_action_textsearch.tpl 83 2008-12-17 04:04:58Z mateo $ *]-->
...
<ol>
  ...
  <li><a href="<!--[pnmodurl modname='wikula' tag=$result.page_tag]-->" title="<!--[$result.page_tag]-->"><!--[$result.page_tag]--></a></li>
  <!--[/foreach]-->
</ol>
<br />
<!--[pnmodurl modname='wikula' tag=$TextSearchExpandedTag phrase=$phrase assign='searchurl']-->
...
<p>
  ...
  <a href="<!--[pnmodurl modname='wikula' type='user' func='edit' tag=$phrase|capitalize:true|replace:' ':''|formatpermalink]-->">
    <!--[gt text='Click here to create a new page named "%s"' tag1=$phrase|pnvarprepfordisplay]-->
  </a>.
  <!--[/if]-->
</p>
<!--[/if]-->
