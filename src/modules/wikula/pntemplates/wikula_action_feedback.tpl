<!--[* $Id: wikula_action_feedback.tpl 41 2008-10-09 18:29:16Z quan $ *]-->
...
<blockquote>
  ...
  <!--[else]-->
    ...
    <form action="<!--[pnmodurl modname='wikula' type='user' func='main' tag=$tag|urlencode]-->" method="post" enctype="application/x-www-form-urlencoded">
