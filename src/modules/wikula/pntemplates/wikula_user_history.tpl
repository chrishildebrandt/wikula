...
<div id="wikula">
  ...
  <!--[foreach name='object' item='object' from=$objects]-->
    ...
    <!--[if $avatar eq '' OR $avatar eq 'blank.gif']-->
      <!--[pnimg modname='wikula' src='avatar_male.gif' width='20' class='avatar']-->
    <!--[else]-->
      <img src="images/avatar/<!--[$avatar|pnvarprepfordisplay]-->" class="avatar" width="20" />
    <!--[/if]-->
    ...
    <!--[else]-->
      <!--[gt text='Edit']--> 
    <!--[/if]-->
    <a href="<!--[pnmodurl modname='wikula' func='main' tag=$tag time=$object.pageAtimeurl]-->" title="<!--[$tag]--> - <!--[$object.pageAtime]-->"><!--[$object.pageAtime]--></a> 
  ...
  <strong><!--[gt text='Oldest known version of this page was edited on']--> <a href="<!--[pnmodurl modname='wikula' func='main' tag=$tag time=$oldest.time|@urlencode]-->" title="<!--[$tag]--> - <!--[$oldest.time]-->"><!--[$oldest.time]--></a> 
