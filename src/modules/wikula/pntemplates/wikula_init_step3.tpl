...
<br />
<!--[pnimg src='wizard_reverse.gif' __alt='wizard' modname='wikula']-->
<br /><br />

<h3><!--[gt text='Installation Summary']--></h3>
<div class="z-formrow">
    <div style="float:left;  width:49%; text-align:right;"><!--[gt text='Root Page']-->: </div>
    <div style="float:right; width:49%; text-align:left;"><strong><!--[$root_page|pnvarprepfordisplay]--></strong></div>
</div>
<div class="z-formrow">
    <div style="float:left;  width:49%; text-align:right;"><!--[gt text='Items per page']-->: </div>
    <div style="float:right; width:49%; text-align:left;"><strong><!--[$itemsperpage|pnvarprepfordisplay]--></strong></div>
</div>
<div class="z-formrow">
...
<div class="z-formrow">
    ...
    <div style="float:right; width:49%; text-align:left;"><strong><!--[$admincategory|pnvarprepfordisplay]--></strong></div>
</div>
<div class="z-formrow">
...
<a href="<!--[pnmodurl modname='wikula' type='init' func='step2']-->" title="<!--[gt text='Back']-->"><!--[gt text='Back']--></a> 
<!--[gt text='or']--> 
<a href="<!--[pnmodurl modname='Modules' type='admin' func='initialise' authid=$authid activate=$activate]-->" title="<!--[gt text='Continue']-->"><!--[gt text='Continue']--></a>
</div>
</fieldset>
</div>
