<!--[* $Id: wikula_action_pageindex.tpl 58 2008-11-14 21:10:52Z arg $ *]-->
...
<strong><a href="<!--[pnmodurl modname='wikula' tag=$currentpage|urlencode]-->" title="<!--[gt text='All']-->"><!--[gt text='All']--></a></strong>
<!--[foreach item='letter' from=$headerletters]-->
  &nbsp;&nbsp;<strong><a href="<!--[pnmodurl modname='wikula' letter=$letter tag=$currentpage|urlencode]-->" title="<!--[$letter]-->"><!--[$letter]--></a></strong>
<!--[/foreach]-->
<br /><br />
...
<!--[foreach from=$pagelist key='firstchar' item='pagesinletter']-->
  ...
  <!--[foreach from=$pagesinletter item='page']-->
    &nbsp;&nbsp;&nbsp;<a href="<!--[pnmodurl modname='wikula' tag=$page.tag|urlencode]-->" title="<!--[$page.tag]-->"><!--[getTitleByTag tag=$page.tag body=$page.body]--></a>
