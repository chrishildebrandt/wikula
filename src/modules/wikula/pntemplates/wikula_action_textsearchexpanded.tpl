<!--[* $Id: wikula_action_textsearchexpanded.tpl 41 2008-10-09 18:29:16Z quan $ *]-->

<form action="<!--[pnmodurl modname='wikula' type='user' func='main' tag=$TextSearchExpandedTag]-->" method="post" enctype="application/x-www-form-urlencoded">
<div>
  <label for="wikula_action_phrase"><!--[gt text='Search for']--></label>
  <input id="wikula_action_phrase" class="searchbox" name="phrase" size="35" value="<!--[$phrase]-->" />
...
<ol>
  ...
  <li>
    <a href="<!--[pnmodurl modname='wikula' tag=$result.page_tag]-->" title="<!--[$result.page_tag]-->"><!--[$result.page_tag]--></a> &mdash; <!--[$result.page_time]-->
...
<p>
  ...
  <!--[if $phrase neq '']-->
  <br />
  <a href="<!--[pnmodurl modname='wikula' type='user' func='edit' tag=$phrase|capitalize:true|replace:' ':''|formatpermalink]-->">
    <!--[gt text='Click here to create a new page named "%tag%"' tag=$phrase|pnvarprepfordisplay]-->
  </a>.
  <!--[/if]-->
</p>
<!--[/if]-->
