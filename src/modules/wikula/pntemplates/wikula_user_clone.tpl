...
<div id="wikula">
  <div class="page">
    ...
    <form action="<!--[pnmodurl modname='wikula' type='user' func='clone']-->" method="post" enctype="application/x-www-form-urlencoded">
    <div id="wikula_cloneform">
      <!--[pnmodurl modname='wikula' tag=$tag|urlencode assign='pageurl']-->
      <h3><!--[gt text='Clone <a href="%1$s">%1$s</a>' tag2=$tag|pnvarprepfordisplay tag1=$pageurl]--></h3>
