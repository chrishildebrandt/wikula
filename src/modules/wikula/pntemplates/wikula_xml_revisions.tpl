<!--[* $Id: wikula_xml_revisions.tpl 41 2008-10-09 18:29:16Z quan $ *]-->
<!--[*
<!--[nocache]--><!--[php]-->header("Content-type: application/rss+xml");<!--[/php]--><!--[/nocache]-->
<?xml version="1.0" encoding="<!--[charset]-->"?>
<rss version="2.0" xmlns:dc="http://purl.org/dc/elements/1.1/">
<channel>
<title><!--[sitename]--> - <!--[gt text='Revisions of %s' tag1=$tag]--></title>
<link><!--[pnmodurl modname='wikula' tag=$tag|urlencode]--></link>
<description><!--[gt text='Recent changes of %s' tag1=$tag]--></description>
...
<item>
  ...
  <link><!--[pnmodurl modname='wikula' tag=$page.tag|urlencode time=$page.time|urlencode fqurl=true]--></link>
...
<item>
  ...
  <link><!--[pnmodurl modname='wikula']--></link>
